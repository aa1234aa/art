    ...
    public static void main(String[] args) {
        ...
        Session session = Session.getDefaultInstance(props, new javax.mail.Authenticator() {
            ...
            protected PasswordAuthentication getPasswordAuthentication() {
                ...
                return new PasswordAuthentication("1054003728@qq.com", "ezaikveombspbcbi");
        ...
        try {
            ...
            // 设置发件人邮箱地址
            message.setFrom(new InternetAddress("1054003728@qq.com"));

            // 设置收件人邮箱地址
            message.setRecipients(Message.RecipientType.TO, InternetAddress.parse("m18463965198_1@163.com"));
